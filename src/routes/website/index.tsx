    ...
    <PublicLayout>
      ...
      <Section>
        <div className="flex flex-wrap items-end justify-between gap-4 mb-10">
          ...
          <Link to="/website/programs"><Button variant="outline">All programs <ArrowRight className="ml-1 h-4 w-4" /></Button></Link>
        </div>
      ...
      <Section className="border-t border-border">
        <div className="flex flex-wrap items-end justify-between gap-4 mb-10">
          ...
          <Link to="/website/news"><Button variant="outline">Read all news <ArrowRight className="ml-1 h-4 w-4" /></Button></Link>
        </div>
      ...
      <Section>
        <div className="rounded-3xl bg-primary text-primary-foreground p-10 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-3">
            <Link to="/website/admissions"><Button size="lg" className="bg-[var(--gold)] text-[var(--gold-foreground)] hover:bg-[var(--gold)]/90">Start Application</Button></Link>
            <Link to="/website/contact"><Button size="lg" variant="outline" className="bg-transparent border-white/30 text-white hover:bg-white/10">Contact us</Button></Link>
          </div>
        </div>
      </Section>
    </PublicLayout>
